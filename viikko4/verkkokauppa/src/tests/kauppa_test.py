...
class TestKauppa(unittest.TestCase):
    ...
    def test_maksettaessa_kaksi_ostosta_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        # tehdään toteutus saldo-metodille
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_maksettaessa_kaksi_samaa_ostosta_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        # tehdään toteutus saldo-metodille
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 10
    ...
    def test_maksettaessa_ostos_joka_on_loppu_pankin_metodia_tilisiirto_kutsutaan_oikeilla_parametreilla(self):
        # tehdään toteutus saldo-metodille
        def varasto_saldo(tuote_id):
            if tuote_id == 1:
                return 0
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu
        self.pankki_mock.tilisiirto.assert_called_with("pekka", ANY, "12345", ANY, 4)
        # toistaiseksi ei välitetä kutsuun liittyvistä argumenteista
...
#                return 10
        ...
        # otetaan toteutukset käyttöön
        self.varasto_mock.saldo.side_effect = [10, 9, 10]
        self.varasto_mock.hae_tuote.side_effect = varasto_hae_tuote
        ...
        assert self.varasto_mock.saldo(1) == 9

        self.kauppa.poista_korista(1)

        assert self.varasto_mock.saldo(1) == 10
